-- Script para criar usuários de teste no sistema jcpe
...
('admin', 'admin@jcpe.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Administrador do Sistema', 'ADMIN', true, NOW(), 'Administrador responsável pelo sistema jcpe', 'https://via.placeholder.com/150'),
('jornalista1', 'jornalista1@jcpe.com', '$2a$10$JKlV4Z3p1iLF9mPq2ixu.OqQ3L7M9nF5YPsVzw0dIYzX8E9qJn7zC', 'Maria Silva', 'JORNALISTA', true, NOW(), 'Jornalista especializada em política e economia', 'https://via.placeholder.com/150'),
('jornalista2', 'jornalista2@jcpe.com', '$2a$10$JKlV4Z3p1iLF9mPq2ixu.OqQ3L7M9nF5YPsVzw0dIYzX8E9qJn7zC', 'João Santos', 'JORNALISTA', true, NOW(), 'Jornalista de esportes e entretenimento', 'https://via.placeholder.com/150'),
('user1', 'user1@jcpe.com', '$2a$10$JKlV4Z3p1iLF9mPq2ixu.OqQ3L7M9nF5YPsVzw0dIYzX8E9qJn7zC', 'Ana Costa', 'USER', true, NOW(), 'Leitora assídua de notícias', 'https://via.placeholder.com/150'),
('user2', 'user2@jcpe.com', '$2a$10$JKlV4Z3p1iLF9mPq2ixu.OqQ3L7M9nF5YPsVzw0dIYzX8E9qJn7zC', 'Pedro Oliveira', 'USER', true, NOW(), 'Interessado em tecnologia e inovação', 'https://via.placeholder.com/150');
