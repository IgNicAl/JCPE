...
import './OutrosEsportes.css';

const OutrosEsportes: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('esportes/outros');
  ...
  if (loading) {
    return (
      <div className="outros-esportes-page">
    ...
    <div className="outros-esportes-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Notícias sobre vôlei, basquete, atletismo e outros esportes
        </p>
      </div>
