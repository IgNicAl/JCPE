...
const TabelaBrasileirao: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('esportes/tabela');
  ...
  if (loading) {
    return (
      <div className="tabela-brasileirao-page">
    ...
    <div className="tabela-brasileirao-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Classificação, resultados e próximos jogos do Campeonato Brasileiro
        </p>
      </div>
