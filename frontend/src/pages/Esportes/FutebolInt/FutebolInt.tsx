...
import './FutebolInt.css';

const FutebolInt: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('esportes/futebol-int');
  ...
  if (loading) {
    return (
      <div className="futebol-int-page">
    ...
    <div className="futebol-int-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Notícias sobre Champions League, Copa do Mundo e futebol internacional
        </p>
      </div>
