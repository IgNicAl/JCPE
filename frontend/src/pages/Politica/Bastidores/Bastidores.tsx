...
const Bastidores: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('politica/bastidores');
    ...
    <div className="bastidores-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Bastidores da política, articulações e negociações políticas
        </p>
      </div>
