...
const Eleicoes: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('politica/eleicoes');
    ...
    <div className="eleicoes-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Notícias sobre eleições, campanhas eleitorais e processo eleitoral
        </p>
      </div>
