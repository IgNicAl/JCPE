...
const Reforma: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('politica/reforma');
    ...
    <div className="reforma-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Notícias sobre a Reforma Tributária e mudanças no sistema de impostos
        </p>
      </div>
