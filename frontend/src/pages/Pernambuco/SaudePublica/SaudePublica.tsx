...
const SaudePublica: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('pernambuco/saude');
  ...
  if (loading) {
    return (
      <div className="saude-publica-page">
    ...
    <div className="saude-publica-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Notícias sobre o sistema de saúde pública em Pernambuco
        </p>
      </div>
