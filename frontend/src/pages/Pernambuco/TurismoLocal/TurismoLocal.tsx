...
const TurismoLocal: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('pernambuco/turismo');
  ...
  if (loading) {
    return (
      <div className="turismo-local-page">
    ...
    <div className="turismo-local-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Notícias sobre turismo, eventos e atrações em Pernambuco
        </p>
      </div>
