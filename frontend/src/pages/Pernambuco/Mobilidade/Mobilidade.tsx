...
const Mobilidade: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('pernambuco/mobilidade');
    ...
    <div className="mobilidade-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Notícias sobre transporte público, trânsito e mobilidade urbana em Pernambuco
        </p>
      </div>
