...
import './Metropolitana.css';

const Metropolitana: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('pernambuco/metropolitana');
  ...
  if (loading) {
    return (
      <div className="metropolitana-page">
    ...
    <div className="metropolitana-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Notícias sobre a Região Metropolitana do Recife e suas cidades
        </p>
      </div>
