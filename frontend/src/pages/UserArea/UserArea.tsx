...
type TabType = 'dados' | 'pontos' | 'sair';
            ...
            <div className="profile-section">
              {profile ? (
                <>
                    ...
                    >
                      {localAvatar ? (
                        ...
                        <div style={{ fontWeight: 800, color: '#777' }}>
                          {(profile.name || profile.username || 'U').slice(0, 2).toUpperCase()}
                        </div>
                      )}
                    </div>
                    <div>
                  ...
                  <div className="profile-row">
                    <strong>Registro:</strong> {new Date(profile.registrationDate).toLocaleDateString('pt-BR')}
                  </div>
                </>
              ) : (
          ...
          {tab === 'sair' && (
            <div className="logout-section">
              ...
              <div className="logout-actions">
                <button className="btn-cancel" onClick={() => setTab('dados')}>
                  Voltar
                </button>
