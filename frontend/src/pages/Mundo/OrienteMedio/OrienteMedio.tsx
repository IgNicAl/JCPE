...
const OrienteMedio: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('mundo/oriente-medio');
  ...
  if (loading) {
    return (
      <div className="oriente-medio-page">
    ...
    <div className="oriente-medio-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Notícias sobre países do Oriente Médio, conflitos e política regional
        </p>
      </div>
