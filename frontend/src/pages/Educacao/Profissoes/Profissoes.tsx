...
const Profissoes: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('educacao/profissoes');
    ...
    <div className="profissoes-page">
      <div className="page-header">
        <div className="breadcrumb">
          <Link to="/">Home</Link>
          <span>/</span>
          <Link to="/categoria/educacao">Educação</Link>
          <span>/</span>
        ...
        <p className="category-description">
          Carreiras, orientação profissional e mercado de trabalho
        </p>
      </div>
