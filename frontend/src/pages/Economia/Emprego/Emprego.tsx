...
const Emprego: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('economia/emprego');
    ...
    <div className="emprego-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Oportunidades de trabalho, concursos públicos e mercado de trabalho
        </p>
      </div>
