...
const BemEstar: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('saude/bem-estar');
    ...
    <div className="bem-estar-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Qualidade de vida, relaxamento e práticas para o bem-estar integral
        </p>
      </div>
