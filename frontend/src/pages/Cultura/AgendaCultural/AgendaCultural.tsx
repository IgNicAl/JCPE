...
const AgendaCultural: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('cultura/agenda');
  ...
  if (loading) {
    return (
      <div className="agenda-cultural-page">
    ...
    <div className="agenda-cultural-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Programação de eventos culturais, shows, exposições e atividades
        </p>
      </div>
