...
const ArtesPlasticas: React.FC = () => {
  ...
  const fetchNews = async () => {
    try {
      setLoading(true);
      const response = await newsService.getByCategory('cultura/artes');
  ...
  if (loading) {
    return (
      <div className="artes-plasticas-page">
    ...
    <div className="artes-plasticas-page">
      <div className="page-header">
        ...
        <p className="category-description">
          Notícias sobre exposições, artistas plásticos, galerias e artes visuais
        </p>
      </div>
