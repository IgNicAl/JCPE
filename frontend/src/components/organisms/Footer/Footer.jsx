      ...
      <div className={styles.footerContainer}>
        ...
        <div className={styles.footerLogoSection}>
          ...
          <div className={styles.footerSocial}>
            <a href="#" className={styles.socialIcon}><Icon name="fa-facebook" /></a>
            <a href="#" className={styles.socialIcon}><Icon name="fa-instagram" /></a>
            <a href="#" className={styles.socialIcon}><Icon name="fa-x-twitter" /></a>
            <a href="#" className={styles.socialIcon}><Icon name="fa-linkedin" /></a>
            <a href="#" className={styles.socialIcon}><Icon name="fa-youtube" /></a>
            <a href="#" className={styles.socialIcon}><Icon name="fa-tiktok" /></a>
            <a href="#" className={styles.socialIcon}><Icon name="fa-whatsapp" /></a>
          </div>
        </div>
        ...
        <div className={styles.footerColumns}>
          ...
          <div className={styles.footerColumn}>
            ...
            <ul>
              <li>
                <a href="#"><Icon name="fa-play-circle" /> Rádio Jornal</a>
              </li>
              <li>
                <a href="#"><Icon name="fa-play-circle" /> Caruaru</a>
              </li>
              <li>
                <a href="#"><Icon name="fa-play-circle" /> Garanhuns</a>
              </li>
              <li>
                <a href="#"><Icon name="fa-play-circle" /> Petrolina</a>
              </li>
              <li>
                <a href="#"><Icon name="fa-play-circle" /> TV Jornal</a>
              </li>
              <li>
                <a href="#"><Icon name="fa-play-circle" /> Recife</a>
              </li>
              <li>
                <a href="#"><Icon name="fa-play-circle" /> Interior</a>
              </li>
            </ul>
          </div>
